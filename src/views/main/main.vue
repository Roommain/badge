  ...
  <div class="main">
    <el-container>
        <el-header class="header" style="height: 100px;">
            <div class="main-logo">
              <img class="logo" src="@/assets/carimg/logo.png" alt=""><span class="logo-title">数字徽章教育</span> 
            </div>
            <nav class="main-nav">
                <!-- <router-link tag="li" to="/home" active-class="active">&nbsp;&nbsp;首页</router-link> -->
                <router-link v-show="!adminShow" tag="li" to="/collect">&nbsp;&nbsp;徽章</router-link>
                <router-link v-show="!adminShow" tag="li" to="/assess">&nbsp;&nbsp;评估</router-link>
                <router-link v-show="!adminShow" tag="li" to="/course_all">&nbsp;&nbsp;课程</router-link>
                <router-link v-show="!adminShow" tag="li" to="/team">&nbsp;&nbsp;团队</router-link>
                <router-link v-show="adminShow" tag="li" to="/StudentInformation">&nbsp;&nbsp;后台管理</router-link>
            </nav>
