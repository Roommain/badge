        ...
        <div class="user-message-header utils-menu-header-style">
            ...
            <div class="user-menu-bar">
                ...
                >
                    ...
                    <MenuItem v-show="adminShow" name="/my_badge"><Icon type="md-contact" />&nbsp;我的徽章</MenuItem>
                    <MenuItem v-show="adminShow" name="/game_declare"><Icon type="md-contact" />&nbsp;创新创业比赛申报</MenuItem>
