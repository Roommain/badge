        ...
        <div class="user-message-header utils-menu-header-style">
            ...
            <div class="user-menu-bar">
                <Menu
                    ...
                    width="320px"
                >
                    <MenuItem name="/myteam"><Icon type="ios-car" />&nbsp;我的团队</MenuItem>
                    <MenuItem name="/team"><Icon type="ios-car" />&nbsp;加入团队</MenuItem>
                    <MenuItem name="/createteam"><Icon type="ios-card-outline" />&nbsp;创建团队</MenuItem>
                    <!-- <MenuItem name="/application"><Icon type="ios-card-outline" />&nbsp;创新创业项目申报</MenuItem> -->
                </Menu>
            </div>
        </div>
        <div class="user-view">
